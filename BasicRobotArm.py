...
class BasicRobotArm:
    def __init__(self, 
        ...
        self.joint2_angle0 = joint2_angle   # initial angle of the second joint
        self.joint1_velocity0 = joint1_velocity   # initial angular velocity of the first joint
        self.joint2_velocity0 = joint2_velocity   # initial angular velocity of the second joint
        self.joint1_torque0 = joint1_torque       # torque applied to the first joint
        self.joint2_torque0 = joint2_torque       # torque applied to the second joint
        ...
        self.L = np.array([[1, 0, -1, 0, 0], [0, 1, 0, -1, 0]])
    ...
    def set_L(self, L=np.array([[-1, 0, -1, 0, 0], [0, -1, 0, -1, 0]])):
        self.L = L
    ...
    def controller(self, L=np.array([[-1, 0, -1, 0], [0, -1, 0, -1]])):
        ...
        force = L @ np.array([[x], [y], [x_dot], [y_dot], [1]])

        # Return the desired force
        return force
    
    def controller_from_states(self, q, q_dot, L=np.array([[-1, 0, -1, 0, 0], [0, -1, 0, -1, 0]])):
        """
        Calculates the desired force to control the robot arm's end-effector position and velocity 
        using a linear feedback controller. The controller gain matrix can be customized by providing L.
        Arguments:
